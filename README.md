...
que serão necessários para a sua montagem. Para perceber melhor o que faz cada componente do robô pode ler o manual técnico ([3_Documentacao/3-5_Manual_Tecnico_iModBot.pdf](https://github.com/Guilherme010101/iModBot2/blob/master/3_Documents/3-01_iModBot_Tech_Manual.pdf)) que explica vários aspetos do robô. 
