...
#include <iModBot.h>  // É necessário incluir a biblioteca

iModBot robot;  // É sempre necessário criar esta linha, a palavra "robot" pode ser outra
...
void setup()
{
  ...
  */
  //                 (trig pin, echo pin );
  robot.editUltrasonicPin(  12, 14);  // Estes são os pinos que a biblioteca usa por defeito.
...
void loop()
{
  ...
  */
  ...
  // Para poder usar funções com base em rotações por segundo/minuto e m/s
  // deve primeiro chamar uma vez a função "enSpeedAdj()"

  robot.enSpeedAdj();

  // Para colocar o robô a seguir em frente especificando 
  // a velocidade em rotações por segundo (RPS)
   
  robot.forwardRPS(2.1);

  // Para colocar o robô a recuar especificando 
  // a velocidade em rotações por segundo (RPS)
   
  robot.reverseRPS(1.8);

  // Para colocar o robô a rodar para a direita especificando 
  // a velocidade em rotações por segundo (RPS)
   
  robot.rotateRightRPS(2.3);

  // Para colocar o robô a rodar para a esquerda especificando 
  // a velocidade em rotações por segundo (RPS)
  ...
  // Para colocar o robô a seguir em frente especificando 
  // a velocidade em rotações por minuto (RPM)
  ...
  // Funções para ler a velocidade da roda direita ou esquerda na unidade especificada:
